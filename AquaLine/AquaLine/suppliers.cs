...
namespace AquaLine
{
    public partial class suppliers : Form
    {
        ...
        */
        public suppliers(Privileges privilege = Privileges.Engineer)
        {
            InitializeComponent();
            ...
            DataTable dt2 = controllerObj.getsuppliers();
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            {
                int r = controllerObj.insertsupplier(textBox1.Text.ToString(), textBox2.Text.ToString(), textBox3.Text.ToString(), textBox4.Text.ToString());
                if (r > 0)
                {
        ...
        {
            int r = controllerObj.deletesupplier(comboBox1.Text);
            if (r > 0)
            {
        ...
        {
            DataTable dt = controllerObj.searchsuppliername(textBox5.Text.ToString());
            dataGridView1.DataSource = dt;
            dataGridView1.Refresh();
        }
        ...
        {
            int r = controllerObj.updatesupplier(comboBox2.Text.ToString(), textBox8.Text.ToString(), textBox7.Text.ToString(), textBox6.Text.ToString());
            if (r > 0)
