...
namespace AquaLine
{
    public partial class stock : Form
    {
        ...
        */
        public stock(Privileges privilege = Privileges.Engineer)
        {
            InitializeComponent();
            ...
            DataTable dt = controllerObj.getstockitems();
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            {
                int r = controllerObj.insertstockitem(textBox1.Text.ToString(), textBox2.Text.ToString(),textBox4.Text.ToString());
                if (r > 0)
                {
        ...
        {
            int r = controllerObj.deletestockitems(comboBox1.Text);
            if (r > 0)
            {
        ...
        {
            DataTable dt = controllerObj.getorderincludingitem(comboBox2.Text.ToString());
        ...
        {
            DataTable dt = controllerObj.searchstockitemname(textBox3.Text.ToString());
            dataGridView1.DataSource = dt;
            dataGridView1.Refresh();
        }
        ...
        {
            int r = controllerObj.updatestockitem(comboBox3.Text, textBox8.Text.ToString(), textBox7.Text.ToString());
            if (r > 0)
